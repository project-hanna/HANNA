...
# --- 3. ARCHITECTURE CSS BDD9 (HAUTEUR 22PX) ---
st.markdown(f"""
    <style>
    ...
    div.stTextInput input {{ 
        text-align: left !important; padding: 0 15px !important;
        border-radius: 8px !important; border: 1px solid #EEE !important;
        height: 22px !important; line-height: 22px !important; 
        font-size: 13px !important; /* Ajustement police pour 22px */
    }}
    div.stTextInput input::placeholder, div.stTextInput input::-webkit-input-placeholder {{ 
...
# --- 3. ARCHITECTURE CSS BDD9 (STRICT VERTICAL ALIGN) ---
st.markdown(f"""
    <style>
    .main .block-container {{
        max-width: 550px !important; padding: 4rem 1rem !important; margin: 0 auto !important;
