...
# --- 3. CSS FORCE-CENTER (CORRECTIF DÉFINITIF) ---
st.markdown(f"""
    <style>
    /* Écrase les marges de Streamlit pour centrer le bloc principal */
    ...
    /* Force le centrage de tous les éléments injectés par Streamlit */
    ...
    .hanna-title {{
        ...
        margin: 0 !important;
        padding-left: 14px; /* Compense le letter-spacing pour le milieu exact */
        line-height: 1.1;
    }}
    ...
    div.stTextInput input {{ text-align: center !important; border-radius: 10px !important; }}
    .stButton > button {{ width: 100% !important; border-radius: 10px !important; border: 1px solid #EEE !important; }}

    #MainMenu, footer, header {{ visibility: hidden; height: 0; }}
    </style>
""", unsafe_allow_html=True)

# --- 4. AFFICHAGE DIRECT (PAS DE PAGE DE CONNEXION) ---
